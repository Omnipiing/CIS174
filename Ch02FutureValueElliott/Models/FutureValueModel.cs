...
namespace Ch02FutureValueElliott.Models
{
    public class FutureValueModel
    {
        ...
        [Required(ErrorMessage = "Please enter a yearly interst rate.")]
        ...
        public decimal? CalculateFutureValue()
        {
            ...
            decimal monthlyInterstRate = YearlyInterestRate.Value / 12 / 100;
            decimal futureValue = 0;
            for (int i = 0; i < months; i++)
            {
                futureValue = (futureValue + MonthlyInvestment.Value) * (1 + monthlyInterstRate);
            }
            return futureValue;
        }
    }
